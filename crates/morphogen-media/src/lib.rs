...
pub use extract::{
    ...
    extract_audio_wav_with_max_duration, extract_video_frames,
};
pub use ffmpeg::{
    decode_avi_frames_command, encode_datamosh_avi_command, encode_datamosh_avi_command_scaled,
    extract_audio_wav_command, extract_audio_wav_command_with_max_duration,
    extract_video_frames_command, ffmpeg_version, ffprobe_command, CommandSpec,
};
