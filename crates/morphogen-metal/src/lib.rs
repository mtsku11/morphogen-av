...
pub use flow_displace_dispatch::{
    ...
    validate_convolution_blend_shader_source, validate_fluid_advect_shader_source,
    validate_flow_displace_shader_source,
    ...
    FLUID_ADVECT_KERNEL_NAME, FLUID_ADVECT_SHADER_SOURCE,
...
pub use runtime::{
    ...
    flow_displace_metal, flow_feedback_metal, fluid_advect_metal, granular_mosaic_metal,
