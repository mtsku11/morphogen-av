...
pub use flow_displace_dispatch::{
    ...
    validate_granular_mosaic_shader_source, FlowDisplaceDispatchPlan, GranularMosaicDispatchPlan,
    ...
    GRANULAR_MOSAIC_KERNEL_NAME, GRANULAR_MOSAIC_SHADER_SOURCE,
};
pub use pipeline_placeholder::MetalPipelinePlan;
#[cfg(target_os = "macos")]
pub use runtime::{flow_displace_metal, flow_feedback_metal, granular_mosaic_metal};
