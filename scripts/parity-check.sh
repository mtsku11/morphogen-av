...
if [ -f "$manifest" ]; then
  ...
  grep -E '"(pool_window|anti_repeat_weight|anti_repeat_cooldown|coherence_weight|coherence_reach|spatial_coherence_weight|audio_weight|texture_weight|modulator_centroid_cache|carrier_centroid_cache|backend)"' \
